...
split1 = split2 = None
if dual_toggle:
    st.markdown("**Specify how to split pallets into two despatches, e.g. for one order in which 2 pallets are depsatching from ESl and 3 from U4, you would enter 2 and 3.**")
